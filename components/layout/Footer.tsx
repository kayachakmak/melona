...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-[#3D4A32] text-white min-h-screen flex flex-col pb-0">
      {/* Top Section - Info Grid */}
      <div className="px-6 lg:px-12 py-12 flex-1">
      ...
      {/* Large Brand Name */}
      <div className="px-2 lg:px-4 pt-12 lg:pt-16 pb-0 text-center flex-1 flex flex-col justify-end">
        <Link href="/" className="block w-full m-0 p-0">
          <h2 className="font-serif text-[clamp(4rem,25vh,30rem)] leading-[0.85] tracking-tight font-extralight m-0 p-0">
            Melona Dent
          </h2>
          <h2 className="font-serif text-[clamp(4rem,25vh,30rem)] leading-[0.85] tracking-tight font-extralight mt-[-0.1em] mb-0 pb-0 m-0">
            Clinic
          </h2>
        </Link>
      </div>
