  ...
  return (
    <>
      ...
      <main className="bg-[#FAF9F6]">
        {/* Hero Section */}
        <section className="pt-24 pb-10 sm:pb-12 lg:pt-3 lg:pb-24">
          <div className="mx-auto max-w-9xl px-4 sm:px-6 lg:px-2">
            ...
            <p className="mt-4 sm:mt-6 max-w-2xl text-lg text-[#3D4A32]/70 leading-relaxed lg:text-xl">
        ...
        {/* Case Study Grid + Detail View */}
        <CaseStudyView studies={caseStudies} />

        {/* CTA Section */}
        <section className="py-16 sm:py-20 lg:py-32 bg-[#3D4A32]">
